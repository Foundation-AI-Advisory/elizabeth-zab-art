...
Two prototypes, each in its own folder, each with vercel.json pinning the project name.
...
Recommended:
  ...
  3. The script deploys both projects in sequence.
  4. URLs are printed to the terminal AND saved to _DEPLOY_URLS.txt.
  5. Share the 2 URLs back to the assistant for verification.
